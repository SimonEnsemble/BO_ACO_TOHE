...
{\color{red} well below is specific to orienteering. should mention orienteering. risky orienteering, call it that?}
...
{\color{red} the path is a tuple. just use ordered list.}
...
{ \color{red} pretty sure we gotta assume edge $(u,v)$ existence implies edge $(v, u)$ or we'll get stuck when there's a lone node? }
