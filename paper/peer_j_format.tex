...
The reward and survival pheromone maps are shared by the ant colony as a collective memory.
In the trail construction rule in eqn.~\ref{eq:prob_x_y} and the pheromone laying rule in eqn.~\ref{eq:tau_update}, the pheromone maps are also shared by the robots on the team.
