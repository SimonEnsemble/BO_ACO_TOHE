...
conduct an ablation study to quantify the importance of the pheromone and heuristics for guiding the search;
and benchmark ACO against [naive] random search and [more competitive] simulated annealing. 
...
\begin{figure}[h!]
    ...
    (a) Problem setup: the directed graph, robot team at the base node, node rewards, and edge survival probabilities. 
    (b) Performance of different search algorithms at finding the Pareto-optimal team-trail plans as iterations proceed. Average and standard deviation over four runs depicted.
    (c) Pareto front of robot-team trail plans at the end of a run of ACO with three plans shown (from top to bottom: high-survival, low-reward; medium-survival, medium reward; low-survival, high-reward).
    (d) Pheromone trails at the end of a run of ACO.
    } \label{fig:two_community}
\end{figure}

\subsection{San Diego Art Museum}
...
\subsection{Satsop Nuclear Power Plant}
