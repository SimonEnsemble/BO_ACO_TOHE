...
Path-planning for mobile robots in static, dynamic, or unknown environments under various objectives (e.g., least-cost paths) and constraints (e.g., collision avoidance) \cite{karur2021survey,sanchez2021path,yang2023path,costa2019survey} is important for task performance, efficiency, safety, and autonomy.
