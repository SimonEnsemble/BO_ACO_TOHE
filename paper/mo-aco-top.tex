...
We then can present the Pareto-optimal set to a human decision-maker that selects the robot-team trail plans that makes some tradeoff between the two objectives, based on his or her value of rewards vs. robot survival. 
