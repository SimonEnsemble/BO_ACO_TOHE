...
# ╔═╡ 4564f744-32fc-11ee-2434-4f2928bef369
using GeoMakie, CSV, DataFrames, CairoMakie

# ╔═╡ 8e1a1c1c-ae9f-42ce-9c6c-7ee11e83ae18
md"this was downloaded from the coral triangle atlas"

# ╔═╡ b7f4b84e-6d84-4dd7-946b-b89bdc66bcff
data = CSV.read("mpalist.csv", DataFrame)

# ╔═╡ 37bbb688-d57d-48d4-9a3d-190555921b62
for l in ["LON", "LAT"]
	@show l
	@show minimum(data[:, l])
	@show maximum(data[:, l])
...
# ╔═╡ 4544b83f-510f-4bec-82f8-2a416f933272
begin
	fig = Figure()
	ga = GeoAxis(
		...
		lonlims=(94, 166), latlims = (-11, 21)
	)
	scatter!(ga, data[:, "LON"], data[:, "LAT"])
	fig
end
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "bcf01b2faac1edb08536b4a93918dbbc3d48c1cc"
